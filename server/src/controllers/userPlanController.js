...
const stripe = Stripe(
    "sk_test_51QSBs2F1BVeaeMn2zhPaHbSmtv7cnQWXGXlMooMPGizgDTMmEgcTLQ9j9mHavfF4M7BsOG6WKNX6M3tUGOVHoQlW00uESxXwlO"
);
const createSubscriptionCheckout = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        console.log(
            "Error from the createSubscriptionCheckout (userPlanController)",
            error
        );
