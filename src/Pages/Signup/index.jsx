...
const Index = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Create a new object without unnecessary fields
        const submissionData = { ...formData };
    
        if (formData.role === "admin") {
            delete submissionData.name; // Remove 'name' if registering as admin
        } else {
            delete submissionData.companyName; // Remove 'companyName' if registering as user
        }
    
        if (formData.role === "admin") {
            signupComapny(submissionData, {
                onSuccess: () => {
                    setRedirect(true);
