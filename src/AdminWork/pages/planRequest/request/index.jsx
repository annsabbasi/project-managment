            ...
            <TableBody sx={{ borderTop: '12px solid white' }}>
                <TableRow className={style.tableRowBody}>
                    ...
                    <TableCell align="left" >
                        <Button variant="contained" className={`${styles.btnDecline} ${style.tableBodyBtn}`} size="medium">
                            Decline
                        </Button>
                        <Button variant="contained" className={`${style.tableBodyBtn} ${styles.btnAccept}`} size="medium" sx={{ marginLeft: '10px' }}>
                            Accept
                        </Button>
                    </TableCell>
                </TableRow>
